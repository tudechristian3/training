            ...
            <div class="panel panel-default">
              <?php if($this->session->flashdata('message')){ ?>
                ...
                <div class="panel-heading">
                    ...
                    <h3>Users</h3> <a href="<?php echo base_url('AdminController/deactivate_users')?>" class="btn btn-primary">List of Deactivate User</a>
                ...
                <div class="panel-body">
                  ...
                  <thead>
                    ...
                    <?php foreach($users as $u): ?>
                      <?php if($u['status'] == "User" || $u['status'] == "Deactivate" ): ?>
                  <tbody id="show_data">
                    <td><?php echo $u['user_id']; ?></td>
                    <td><?php echo $u['name']; ?></td>
                    <td><?php echo $u['status']; ?></td>
                    <td><a href="<?php echo base_url('AdminController/deactivate_account')?>/<?php echo $u['user_id']; ?>" class="btn btn-danger">Deactivate</a></td>
                  </tbody>
                  <?php endif; ?>
                    <?php endforeach; ?>
                </table>
